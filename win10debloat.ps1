...
$urlfixwinstartup.Font           = New-Object System.Drawing.Font('Consolas',10)

$tronfullrun                  = New-Object system.Windows.Forms.Button
$tronfullrun.text             = "Tron Full Run"
$tronfullrun.width            = 232
$tronfullrun.height           = 30
$tronfullrun.location         = New-Object System.Drawing.Point(646,745)
...
$urlcreateiso.Font               = New-Object System.Drawing.Font('Consolas',10)
...
$Form.controls.AddRange(@($Panel1,$Panel2,$Label3,$Label15,$Panel4,$PictureBox1,$Label1,$Panel3,$ResultText,$Label10,$Label11,$urlfixwinstartup,$tronfullrun,$urlcreateiso))
